    ...
    run: async (client, message, args) => {
        ...
        if (message.channel.id == '821393051561361493') {
            ...
            let nomember = new MessageEmbed()
                ...
                .addField('Also check, if the user is still on this Server!', 'undefined')
                .setColor('RED')
            ...
            try {
                ...
                if (!message.author.roles.cache.some(r => r.name === roleName.id)) return message.channel.send('you can not!');
